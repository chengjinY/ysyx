...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT_START();
	...
	INSTPAT("??????? ????? ????? 000 ????? 00110 11", addiw , I, R(dest) = BITS(src1 + src2, 31, 0));
	INSTPAT("0000000 ????? ????? 000 ????? 01110 11", addw  , R, R(dest) = BITS(src1 + src2, 31, 0));
  ...
  INSTPAT("0000001 ????? ????? 110 ????? 01110 11", remw 	, R, R(dest) = SEXT(U64(BITS(src1, 31, 0)) % S64(BITS(src2, 31, 0)), 32); Log("%ld %ld %ld", U64(BITS(src1, 31, 0)), S64(BITS(src2, 31, 0)), R(dest)));
